...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.counter = 1         # number of trial helper
        ###########
        ## TO DO ##
        ###########
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = 1 / (self.counter**2)
            #self.epsilon = math.exp(-1*self.counter*0.95)
    ...
    def choose_action(self, state):
        ...
        if self.learning and random.random() > self.epsilon:
            ...
            pos_actions = [act for act in possible_actions if possible_actions[act] == maxVal]
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            self.Q[state][action] = (1-self.alpha)*current_value + self.alpha*reward
        return
